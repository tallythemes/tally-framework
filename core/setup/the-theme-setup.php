...
function tally_setup_admin_notice() {
	if( isset($_GET['page']) && ($_GET['page'] == 'tallykit_impoter-demo-importer') ) return;
	if(get_option('tallykit_data_imported') == 'yes') return;
	$theme = wp_get_theme();
    ?>
    <style type="text/css">
	.tally_setup_notic{
    ...
    <div class="wrap">
        <div class="tally_setup_notic">
            ...
            <a href="<?php echo admin_url( 'themes.php?page=tallykit_impoter-demo-importer'); ?>" class="button button-hero" >Make the Site like the Demo</a>
