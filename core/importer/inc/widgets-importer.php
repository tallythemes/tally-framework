 ...
 */
function tally_process_import_widget_file( $file ) {
	// File exists?
	if ( ! file_exists( $file ) ) {
		wp_die(
 ...
 */
function tally_import_widget_data( $data ) {
	...
	$available_widgets = tally_available_widgets();
 ...
 */
function tally_available_widgets() {
