...
function tally_script_loader(){
	...
	wp_enqueue_script('jquery-wow', tally_assets_file('js/wow.min.js'), array('jquery'), '', true);
	...
	wp_enqueue_style('font-awesome', tally_assets_file('css/font-awesome.min.css'), '', ' 4.2.0');
