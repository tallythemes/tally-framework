...
if('tally_do_footer_copyright'):
	function tally_do_footer_copyright(){
        ...
        echo '<div class="copy_text">';
			echo apply_filters('footer_copyright_text', tally_option('footer_copyright', 'Proudly powered by <a href="http://wordpress.org/" target="_blank" title="A Semantic Personal Publishing Platform" rel="generator">WordPress</a> | Design by <a href="http://tallythemes.com/" target="_blank" rel="designer">TallyThemes</a>'));
        echo '</div>';
	}
